"""
=============================================================================
POPULATE DATABASE - Script para Popular la Base de Datos con Datos de Ejemplo
=============================================================================

Este script crea:
- 4 Planes de subscripción (Free, Basic, Pro, Premium)
- 1 Negocio de ejemplo (Salón de Belleza)
- 3 Servicios
- 2 Profesionales
- 5 Clientes
- 10 Citas de ejemplo
...
if created:
    ...
    print(f"  ✅ Subscripción activa (30 días de prueba)")
else:
    print(f"  ℹ️  Negocio ya existe: {business.name}")
...
for service_data in services_data:
    ...
    if created:
        ...
        print(f"  ℹ️  Ya existe: {service.name}")
...
for prof_data in professionals_data:
    ...
    if created:
        print(f"  ✅ Profesional: {prof.name} - {prof.title}")
    else:
        print(f"  ℹ️  Ya existe: {prof.name}")
...
for client_data in clients_data:
    ...
    if created:
        ...
        print(f"  ℹ️  Ya existe: {client.name}")
...
for i, apt_data in enumerate(appointments_data, 1):
    ...
    if created:
        print(f"  ✅ Cita {i}: {apt.client_name} - {apt.service_name} ({apt.get_status_display()})")
    else:
        print(f"  ℹ️  Ya existe: Cita {i}")
...
🚀 PRÓXIMO PASO:
   Ahora puedes empezar a trabajar en los endpoints de API con JWT
   o continuar con el frontend de autenticación.
""")

print("\n💡 TIP: Refresca el Admin de Django para ver todos los datos creados.")
print("="*80)
